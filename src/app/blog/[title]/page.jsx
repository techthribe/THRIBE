...
const Post = () => {
  ...
  const handleShare = () => {
    // get current url at click time (safe for client-side)
    const currentUrl =
    ...
    if (typeof navigator !== "undefined" && navigator.share) {
      ...
      // fallback: copy to clipboard + notify the user
      if (typeof navigator !== "undefined" && navigator.clipboard?.writeText) {
        ...
        alert("Sharing not supported. Copy the link manually: " + currentUrl);
      }
    }
  };

  // short-circuit: if no matching post show fallback
        ...
        <section className="w-full relative min-h-screen">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-[40px] mt-[24px] w-full md:pl-[55px]">
            ...
            <aside className="w-full md:w-[480px] md:sticky md:top-[50px] self-start">
              {/* self-start ensures the sticky element uses the top offset correctly */}
